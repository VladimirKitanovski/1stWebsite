...
<head><link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css">
...
<!-- Personal Information -->
        		<h1 class="uk-heading-large uk-text-center">HIT ME UP</h1>
  ...
  <form action="action_page.php">
    ...
    <select id="country" name="country">
      ...
      <option value="conta rica">Costa Rica</option>
